package com.example.gestion_user.constants;

public class FileConstant {

    public static final String USER_IMAGE_PATH = "/user/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/bureauordre/user/";
    ...
    public static final String TEMP_PROFILE_IMAGE_BASE_URL = "https://jdenticon.com/";
